        ...
        },
        {
          ...
          items: [
            // assertion-sidebar:start
                { label: "assertArrayEquals", slug: "assertions/assertArrayEquals" },
                { label: "assertArrayIncludesAll", slug: "assertions/assertArrayIncludesAll" },
                { label: "assertArrayIncludes", slug: "assertions/assertArrayIncludes" },
                { label: "assertArrayLength", slug: "assertions/assertArrayLength" },
                { label: "assertArrayMinLength", slug: "assertions/assertArrayMinLength" },
                { label: "assertArrayNotEmpty", slug: "assertions/assertArrayNotEmpty" },
                { label: "assertBufferEqual", slug: "assertions/assertBufferEqual" },
                { label: "assertDirectoryExists", slug: "assertions/assertDirectoryExists" },
                ...
                { label: "assertFileIncludes", slug: "assertions/assertFileIncludes" },
                { label: "assertFileNotIncludes", slug: "assertions/assertFileNotIncludes" },
                ...
                { label: "assertNonNullable", slug: "assertions/assertNonNullable" },
                { label: "assertNumberBetween", slug: "assertions/assertNumberBetween" },
                { label: "assertNumberToNearest", slug: "assertions/assertNumberToNearest" },
                { label: "assertObjectEquals", slug: "assertions/assertObjectEquals" },
                { label: "assertObjectHasProperty", slug: "assertions/assertObjectHasProperty" },
                { label: "assertObjectMatches", slug: "assertions/assertObjectMatches" },
                { label: "assertOneOf", slug: "assertions/assertOneOf" },
                { label: "assertPathExists", slug: "assertions/assertPathExists" },
                { label: "assertPathNotExists", slug: "assertions/assertPathNotExists" },
                { label: "assertResponseStatus", slug: "assertions/assertResponseStatus" },
                { label: "assertSetSize", slug: "assertions/assertSetSize" },
                { label: "assertStringEndsWith", slug: "assertions/assertStringEndsWith" },
                { label: "assertStringIncludes", slug: "assertions/assertStringIncludes" },
                { label: "assertStringLength", slug: "assertions/assertStringLength" },
                { label: "assertStringNotIncludes", slug: "assertions/assertStringNotIncludes" },
                { label: "assertStringStartsWith", slug: "assertions/assertStringStartsWith" },
                { label: "assertThrowsErrorAsync", slug: "assertions/assertThrowsErrorAsync" },
                { label: "assertThrowsErrorLike", slug: "assertions/assertThrowsErrorLike" },
                { label: "assertThrowsError", slug: "assertions/assertThrowsError" },
                { label: "assertTrue", slug: "assertions/assertTrue" },
                { label: "assertTypeBigInt", slug: "assertions/assertTypeBigInt" },
                { label: "assertTypeBoolean", slug: "assertions/assertTypeBoolean" },
                { label: "assertTypeFunction", slug: "assertions/assertTypeFunction" },
                { label: "assertTypeNumber", slug: "assertions/assertTypeNumber" },
                { label: "assertTypeNumeric", slug: "assertions/assertTypeNumeric" },
                ...
                { label: "assertTypeTypedArray", slug: "assertions/assertTypeTypedArray" },
        ...
        },
        {
          ...
          items: [
            // matcher-sidebar:start
                ...
                { label: "objectWithProperty", slug: "matchers/objectWithProperty" },
                { label: "oneOf", slug: "matchers/oneOf" },
                { label: "responseOfStatus", slug: "matchers/responseOfStatus" },
                ...
                { label: "stringNotIncluding", slug: "matchers/stringNotIncluding" },
                { label: "stringStartingWith", slug: "matchers/stringStartingWith" },
